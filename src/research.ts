...
export type Leaning = 'homer' | 'flanders' | 'neutral'
...
export interface Authority {
  ...
  scope: string
  /** What it means for Homer, in one line. */
  application: string
  url: string
...
export const AUTHORITIES: Authority[] = [
  {
    ...
    application:
      'The closest authority to the two bites, and it cuts both ways. Acceptance lands on completion — the second bite, not the first. But the rule it states is about an offeree who completes *after learning*, and Homer completed before he learned anything. Cite it for the timing; distinguish it on knowledge.',
  ...
  },
  {
    ...
    application:
      'The formation argument in one sentence. A first bite is the beginning of a performance, not its completion — so nothing closed on 1 April 2025. Note the sting in the tail: § 45 conditions the deal on full consideration within a *reasonable time*, and Flanders will argue a year in a refrigerator is not one.',
  ...
  },
  {
    ...
    application:
      'The case the count is built on, and it is binding Nevada authority. The buyer kept paying for the car and still rescinded, because she did not yet know the car was used. Homer kept eating and still rescinds, because he did not yet know about the soul.',
  ...
  },
  {
    ...
    application:
      'The best statement of the defense — and it carries its own answer. Every formulation of the rule is conditioned on awareness. Flanders has to put knowledge in Homer’s hands before 14 April 2026, and on the pleaded facts he cannot.',
